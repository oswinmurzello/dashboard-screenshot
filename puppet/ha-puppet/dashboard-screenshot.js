...
function takeScreenshot(requestHandler,params,d,i,file){
...
export function scheduleScreenshots(){
    ...
    const screenshot_files =  dashboard_urls.map((d,i)=>{
        ...
        setInterval(()=>takeScreenshot(requestHandler,params,d,i,file), d.refersh_after_min * 60 * 1000);
        console.log(i,"screenshot interval set");
        takeScreenshot(requestHandler,params,d,i,file)
        return file;
        }catch (err) {
